                ...
                return (q = u((function(e) {
                    ...
                    return i(this, (function(i) {
                        switch (i.label) {
                            ...
                            case 1:
                                return (t = i.sent()) ? (r = x.parsePath(e.asPath), n = r.pathname, a = T.hasBasePath(n) ? R.removeBasePath(n) : n, o = A.addBasePath(M.addLocale(a, e.locale)), [2, t.some((function(e) {
                ...
                ne = function() {
                    function e(t, r, a, o) {
                        ...
                        n(this, e), this.sdc = {}, this.isFirstPopStateEvent = !0, this._key = ee(), this.onPopState = function(e) {
                            ...
                            if (r) {
                                ...
                                var c = y.pathname,
                                    s = y.query;
                                y.changeState("replaceState", j.formatWithValidation({
                        ...
                        if (this.basePath = "", this.sub = p, this.clc = null, this._wrapApp = s, this.isSsr = !0, this.isLocaleDomain = !1, this.isReady = !!(self.__NEXT_DATA__.gssp || self.__NEXT_DATA__.gip || self.__NEXT_DATA__.appGip && !self.__NEXT_DATA__.gsp || (!w && self.location.search, 0)), this.state = {
                            ...
                            this._initialMatchesMiddlewarePromise = B({
                                ...
                                return S._shouldResolveHref = a !== t, y.changeState("replaceState", e ? E : j.formatWithValidation({
                    ...
                    return a(e, [{
                        ...
                        value: function(t, r, n, a, s) {
                            var l = this;
                            return u((function() {
                                var u, f, m, y, g, w, k, L, N, q, Z, W, V, K, X, Q, Y, J, ee, re, ne, ae, oe, ie, ue, ce, se, le, fe, de, pe, he, ve, me, ye, ge, _e, be, Pe, we, Se, Ee, Oe, je, xe, Me, Ce, Re, Ae, Te, ke, Le, Ie, Ne, De, Be, qe, Ze, Ue, He;
                                return i(this, (function(i) {
                                    switch (i.label) {
                                        case 0:
                                            if (!H(r)) return te({
                                            ...
                                            if (u = a._h, f = u || a._shouldResolveHref || x.parsePath(r).pathname === x.parsePath(n).pathname, m = c({}, l.state), y = !0 !== l.isReady, l.isReady = !0, g = l.isSsr, u || (l.isSsr = !1), u && l.clc) return [2, !1];
                                        ...
                                        case 12:
                                            ...
                                            if (Se = ye.error, Ee = ye.props, Oe = ye.__N_SSG, je = ye.__N_SSP, (xe = ye.Component) && xe.unstable_scriptLoader && [].concat(xe.unstable_scriptLoader()).forEach((function(e) {
                            ...
                            return u((function() {
                                ...
                                return i(this, (function(I) {
                                    switch (I.label) {
                                        ...
                                        case 5:
                                            return A = I.sent(), T = A.props, k = A.cacheKey, x.__N_SSP && E.dataHref && delete m.sdc[k], !m.isPreview && x.__N_SSG && J(Object.assign({}, E, {
                                                isBackground: !0,
                                                persistCache: !1,
                                                inflightCache: X
                                            })).catch((function() {})), T.pageProps = Object.assign({}, T.pageProps), x.props = T, x.route = e, x.query = n, x.resolvedAs = o, m.components[e] = x, [2, x];
                                        case 6:
                                ...
                                return i(this, (function(i) {
                                    switch (i.label) {
                                        ...
                                        case 2:
                                            ...
                                            s = C.removeLocale(R.removeBasePath(v.asPath), n.locale), v.matchedPage && v.resolvedHref && (o = v.resolvedHref, a.pathname = o, e = j.formatWithValidation(a)), i.label = 3;
                                        case 3:
                                            return a.pathname = G(a.pathname, c), b.isDynamicRoute(a.pathname) && (o = a.pathname, a.pathname = o, Object.assign(u, E.getRouteMatcher(O.getRouteRegex(a.pathname))(x.parsePath(t).pathname) || {}), e = j.formatWithValidation(a)), m = d.removeTrailingSlash(o), [4, Promise.all([n.pageLoader._isSsg(m).then((function(t) {
                                                return !!t && J({
